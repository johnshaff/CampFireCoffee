...
//     var tRowDataEmployees = document.createElement('td');
//     tRowDataEmployees.textContent = newStore.employeesNeededPerHour[i]; //capitolHill.employeesNeededPerHour[]
//     newLocationRow.appendChild(tRowDataEmployees);
//   }
//   baristasTableElement.appendChild(newLocationRow);// This is why the footer needs to be its own element.
//   // SectionElement.appendChild(baristasTableElement);
//   console.log('suuuup');
// };
...
createBaristaTable(); // I can set this to a var and clear the var if I want.
